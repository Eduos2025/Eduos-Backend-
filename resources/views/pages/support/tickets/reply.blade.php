            ...
            <div class="col-12">
                <div class="card card-collapsed card-ticket">
                    <div class="card-header header-elements-inline">
                        <h6 class="card-title">Reply</span></h6>
                        {!! Qs::getPanelOptions() !!}
                    </div>

                    <div class="card-body">
                        <form method="post" action="{{ route('tickets.store_message') }}">
                            <div class="row">
                                <div class="col-12">
                                    @csrf @method('put')
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <div class="form-group row">
                                                <div class="col-12">
                                                    <textarea placeholder="Message" name="message" id="markdown-editor" data-autosave-unique-id="user-ticket-{{ auth()->id() . $ticket->id }}"></textarea>
                                                </div>
                                            </div>
            ...
            <div class="card-body">
                ...
                <div class="row float-right">
                    <div class="col-4">
                        {{-- Close ticket button --}}
                        <div class="form-group">
                            <a type="button" href="{{ route('tickets.close', Qs::hash($ticket->id)) }}" class="btn btn-sm btn-primary @if($ticket->is_closed()) disabled @endif">Close<span class="material-symbols-rounded ml-2 pb-2px">close</span></a>
                        </div>
                    </div>
                </div>
            </div>

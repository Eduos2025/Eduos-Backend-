                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input value="{{ old('phone2') }}" type="text" name="phone2" id="phone2" data-mask="+9999?999999999" class="form-control" placeholder="+255123456789">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input disabled value="{{ old('phone3') }}" required type="text" name="phone3" id="phone3" class="form-control" placeholder="+255123456789">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="phone4">Close Relative Mobile: </label>
                                        <input disabled value="{{ old('phone4') }}" type="text" name="phone4" id="phone4" class="form-control" placeholder="+255123456789">
                                    </div>
                                </div>
                            </div>
                        </div>
